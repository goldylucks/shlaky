...
describe('facade', () => {
  ...
  test('visualMode - set to dark', () => {
    // when
    facade.visualMode.set('dark'); // then
  ...
  test('visualMode - set to not allowed', () => {
    ...
    expect(throwing).toThrowErrorMatchingSnapshot('visual mode set to not allowed'); // then
...
async function testPopulate({
  ...
  // when
  const populateCall = facade[key].populate(); // then
